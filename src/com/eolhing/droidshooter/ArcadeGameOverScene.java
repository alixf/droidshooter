...
public class ArcadeGameOverScene
{
	// Scene data
	float width;
	float height;
	...
	public ArcadeGameOverScene(int width, int height, Game.Data gameData, Score score)
	{
		// Scene data
		this.width = width;
		this.height = height;
		...
		// Texts
		gameOverText = new Sprite(texture, 148, 940, 225, 35);
		scoreText = new Sprite(texture, 280, 975, 83, 23);
		tryAgainText = new Sprite(texture, 383, 902, 206, 47);
		exitText = new Sprite(texture, 373, 949, 266, 37);
		gameOverText.setPosition(titlePanel.getX() + (float) Math.ceil((titlePanel.getWidth() - gameOverText.getWidth()) / 2.f),
		        titlePanel.getY() + (float) Math.ceil((titlePanel.getHeight() - gameOverText.getHeight()) / 2.f));
		...
		tryAgainText.setPosition(resumePanel.getX() + (float) Math.ceil((resumePanel.getWidth() - tryAgainText.getWidth()) / 2.f),
		        resumePanel.getY() + (float) Math.ceil((resumePanel.getHeight() - tryAgainText.getHeight()) / 2.f));
	...
	public int draw(SpriteBatch batch)
	{
		...
		// Update
		//
		topLeftCorner.setPosition(topLeftCornerX.getValue(), topLeftCornerY.getValue());
		topRightCorner.setPosition(topRightCornerX.getValue(), topRightCornerY.getValue());
		bottomLeftCorner.setPosition(bottomLeftCornerX.getValue(), bottomLeftCornerY.getValue());
		bottomRightCorner.setPosition(bottomRightCornerX.getValue(), bottomRightCornerY.getValue());
		...
		gameOverText.setPosition(titlePanel.getX() + (float) Math.ceil((titlePanel.getWidth() - gameOverText.getWidth()) / 2.f), titlePanel.getY() + (float) Math.ceil((titlePanel.getHeight() - gameOverText.getHeight()) / 2.f));
		scoreText.setPosition(scorePanel.getX() + (float) Math.ceil((scorePanel.getWidth() - scoreText.getWidth()) / 2.f), scorePanel.getY() + (float) Math.ceil((scorePanel.getHeight() - scoreText.getHeight()) / 2.f) + 15.f);
		tryAgainText.setPosition(resumePanel.getX() + (float) Math.ceil((resumePanel.getWidth() - tryAgainText.getWidth()) / 2.f), resumePanel.getY() + (float) Math.ceil((resumePanel.getHeight() - tryAgainText.getHeight()) / 2.f));
		exitText.setPosition(exitPanel.getX() + (float) Math.ceil((exitPanel.getWidth() - exitText.getWidth()) / 2.f), exitPanel.getY() + (float) Math.ceil((exitPanel.getHeight() - exitText.getHeight()) / 2.f));
